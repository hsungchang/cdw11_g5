...
bg5_40323217 = Blueprint('bg5_40323217', __name__, url_prefix='/bg5_40323217', template_folder='templates')
...
@bg5_40323217.route('/circle36/<degree>', defaults={'x': 0, 'y': 0})
@bg5_40323217.route('/circle36/<x>/<degree>', defaults={'y': 0})
@bg5_40323217.route('/circle36/<x>/<y>/<degree>')
#@bg5_40323217.route('/circle36/<int:x>/<int:y>/<int:degree>')
