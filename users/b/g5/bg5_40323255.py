...
bg5_40323255 = Blueprint('bg5_40323255', __name__, url_prefix='/bg5_40323255', template_folder='templates')
...
@bg5_40323255.route('/circle')
def drawcircle():
    return head_str + chain_str + circle(0, 0) + tail_str
 
 
@bg5_40323255.route('/circle1/<degree>', defaults={'x': 0, 'y': 0})
@bg5_40323255.route('/circle1/<x>/<degree>', defaults={'y': 0})
@bg5_40323255.route('/circle1/<x>/<y>/<degree>')
#@bg5_40323255.route('/circle1/<int:x>/<int:y>/<int:degree>')
def drawcircle1(x,y,degree):
    return head_str + chain_str + circle1(int(x), int(y), int(degree)) + tail_str
 
 
@bg5_40323255.route('/circle2/<degree>', defaults={'x': 0, 'y': 0})
@bg5_40323255.route('/circle2/<x>/<degree>', defaults={'y': 0})
@bg5_40323255.route('/circle2/<x>/<y>/<degree>')
#@bg5_40323255.route('/circle2/<int:x>/<int:y>/<int:degree>')
def drawcircle2(x,y,degree):
    return head_str + chain_str + circle2(int(x), int(y), int(degree)) + tail_str
 
 
@bg5_40323255.route('/twocircle/<x>/<y>')
@bg5_40323255.route('/twocircle', defaults={'x':0, 'y':0})
def drawtwocircle(x,y):
    return head_str + chain_str + twocircle(int(x), int(y)) + tail_str
 
 
@bg5_40323255.route('/eighteenthirty/<x>/<y>')
@bg5_40323255.route('/eighteenthirty', defaults={'x':0, 'y':0})
def draweithteenthirdy(x,y):
    return head_str + chain_str + eighteenthirty(int(x), int(y)) + tail_str
 
 
@bg5_40323255.route('/snap')
...
'''
    return outstring
@bg5_40323255.route('/four_gear', defaults={'n1':17,'n2':29,'n3':15,'n4':23})
@bg5_40323255.route('/four_gear/<n1>/<n2>/<n3>/<n4>')
def draw_four_gear(n1, n2, n3,n4):
    outstring='''
<!DOCTYPE html>
<html>
<head>
